...
import { addNewIngridient, setBun } from "../../services/constructorIngridientSlice";
import { selectConstructorIngridients, selectConstructorBun } from "../../services/constructorIngridientSlice";
...
const BurgerConstructor = ({ showModal }) => {
  ...
  return (
    <div className={`text text_type_main-small ${styles.burger__wrapper}`} ref={dropRef}>
      {constructorBun && (
        <div className="ml-8">
          <ConstructorElement
      ...
      <div className={`${styles.ingridients__wrapper} custom-scroll`}>
        {constructorIngredients.map((ingredient, index) => (
          <ConstructorIngridient key={ingredient._constId} ingredient={ingredient} index={index}/>
        ))}
      </div>
      {constructorBun && (
        <div className="ml-8">
